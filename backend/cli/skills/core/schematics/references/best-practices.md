<!-- Adapted from K-Dense Inc.'s scientific-schematics skill (MIT), https://github.com/K-Dense-AI/scientific-agent-skills/tree/main/skills/scientific-schematics. In OpenScience the generator is the native generate_image tool with purpose: "schematic"; the standards below are what its prompts and reviews are held to. -->
